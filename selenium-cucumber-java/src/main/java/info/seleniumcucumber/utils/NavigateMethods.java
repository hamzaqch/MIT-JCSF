...
public class NavigateMethods extends AbstractPage implements BaseTest {
     ...
     * Method to open link
     *
     * @param env : String : URL for navigation
     */
    public void navigateTo(String env) {
        switch (env.toLowerCase()) {
            case "dev":
                getDriver().get(ConfigurationReader.getProperty("dev"));
                break;
            case "uat":
                getDriver().get(ConfigurationReader.getProperty("uat"));
                break;
            default:
